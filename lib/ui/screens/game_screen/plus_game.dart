...
class PlusGame extends StatefulWidget {
  final Color color;

  const PlusGame({super.key, required this.color});

  @override
  State<PlusGame> createState() => _PlusGameState();
}

class _PlusGameState extends State<PlusGame> {
  @override
