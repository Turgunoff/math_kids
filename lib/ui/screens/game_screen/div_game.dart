...
class DivGame extends StatefulWidget {
  final Color color;

  const DivGame({super.key, required this.color});

  @override
  State<DivGame> createState() => _PlusGameState();
}

class _PlusGameState extends State<DivGame> {
  @override
          ...
          ElevatedButton(
              ...
              onPressed: () {
                if (controller.text.isNotEmpty &&
                    int.parse(controller.text) == first) {
